...
Una **matriz** es una forma de organizar valores en una cuadrícula rectangular compuesta de filas y columnas. El tamaño de una matriz se define por el número de filas (**m**) y columnas (**n**): una matriz con 3 filas y 4 columnas se denomina **matriz 3×4**.

$$M = \begin{pmatrix} 1 & 2 & 3 \\ 4 & 5 & 6 \\ 7 & 8 & 9 \end{pmatrix}$$

Las matrices se utilizan en múltiples áreas de la ingeniería:

- Resolución de sistemas de ecuaciones lineales.
- Transformaciones de imágenes (rotaciones, escalas).
- Algoritmos de aprendizaje automático.
- Representación de datos tabulares.

### Crear una matriz en Python { #matrix-create }

En Python, una matriz se implementa como una **lista de listas** (lista 2D). Cada lista interna representa una fila:
...
### Acceder a elementos { #matrix-access }

Para acceder a un elemento usamos dos índices: `matrix[fila][columna]`. Los índices comienzan en **0**:

```pycon
>>> matrix[0][0]  # Primera fila, primera columna
1

>>> matrix[1][2]  # Segunda fila, tercera columna
6

>>> matrix[2][1]  # Tercera fila, segunda columna
8
```

### Modificar un elemento { #matrix-modify }
...
### Ingresar una matriz por teclado { #matrix-input }

Para ingresar los valores desde el teclado usamos dos bucles anidados:
...
### Mostrar una matriz { #matrix-display }

Para mostrar la matriz de forma legible, iteramos sobre las filas:
...
### Suma de matrices { #matrix-sum }

Para sumar dos matrices deben tener el **mismo tamaño**. La suma se realiza elemento a elemento:
...
!!! exercise "Ejercicios"
    ...
    1. Crea una matriz 2×2 manualmente e imprime su contenido.
    2. Dada una matriz 3×3 predefinida, accede al valor de la segunda fila y tercera columna.
    3. Modifica el elemento en la posición (1, 1) por el valor 10 y muestra la matriz actualizada.
    4. Crea una matriz 3×2 y muestra todos sus elementos fila por fila usando un `for` anidado.
    5. Ingresa dos matrices 2×2 por teclado y muestra su suma.

## Ejercicios { #exercises }

1. Escribe un programa que solicite N números al usuario, los almacene en una lista y muestre el mayor, el menor y el promedio.
2. Escribe un programa que solicite una lista de notas y muestre cuántos estudiantes aprobaron (nota >= 4.0) y cuántos reprobaron.
3. Escribe un programa que solicite una lista de números y muestre una nueva lista con solo los números pares.
4. Escribe un programa que solicite una lista de números y la muestre en orden inverso sin usar `reverse()`.
5. Escribe un programa que solicite el tamaño de una matriz cuadrada N×N, llene sus valores por teclado y muestre:
    - La matriz completa.
    - La suma de todos sus elementos.
    - La suma de la diagonal principal.
6. Escribe un programa que sume dos matrices de igual tamaño ingresadas por el usuario.
7. Escribe un programa que multiplique una matriz por un escalar ingresado por el usuario.
